...
import com.shiraken.template_mod.entity.ThirdPhotoEntity;
...
public class ThirdPhotoRenderer extends EntityRenderer<ThirdPhotoEntity> {
    public static int SWAP_TIME_IN_TICKS = 15;

    private static final ResourceLocation SKULL_TEXTURE = new ResourceLocation(TemplateMod.MODID, "textures/entity/third_photo.png");
    private static final ResourceLocation SKULL_AFTER_TEXTURE = new ResourceLocation(TemplateMod.MODID, "textures/entity/third_photo_activated.png");

    public ThirdPhotoRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(ThirdPhotoEntity entity) {
    ...
    @Override
    public void render(ThirdPhotoEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
