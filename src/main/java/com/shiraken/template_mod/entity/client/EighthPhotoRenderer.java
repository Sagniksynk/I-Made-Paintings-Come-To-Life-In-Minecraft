...
public class EighthPhotoRenderer extends EntityRenderer<EighthPhotoEntity> {
    public static int SWAP_TIME_IN_TICKS = 2; // 0.1 seconds into break animation

    private static final ResourceLocation SKULL_TEXTURE = new ResourceLocation(TemplateMod.MODID, "textures/entity/skull_and_roses.png");
    private static final ResourceLocation SKULL_AFTER_TEXTURE = new ResourceLocation(TemplateMod.MODID, "textures/entity/skull_and_rosess_after.png");

    public EighthPhotoRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(EighthPhotoEntity entity) {
    ...
    @Override
    public void render(EighthPhotoEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
