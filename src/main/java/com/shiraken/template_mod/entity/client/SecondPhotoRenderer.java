...
public class SecondPhotoRenderer extends EntityRenderer<SecondPhotoEntity> {
    public static int SWAP_TIME_IN_TICKS = 15;

    private static final ResourceLocation SKULL_TEXTURE = new ResourceLocation(TemplateMod.MODID, "textures/entity/second_photo_before.png");
    private static final ResourceLocation SKULL_AFTER_TEXTURE = new ResourceLocation(TemplateMod.MODID, "textures/entity/second_photo_after.png");

    public SecondPhotoRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(SecondPhotoEntity entity) {
    ...
    @Override
    public void render(SecondPhotoEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
