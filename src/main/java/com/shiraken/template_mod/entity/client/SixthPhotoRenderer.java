...
public class SixthPhotoRenderer extends EntityRenderer<SixthPhotoEntity> {
    private static final ResourceLocation FRAME_NORMAL = new ResourceLocation(TemplateMod.MODID, "textures/item/sixth_photo_item.png");
    private static final ResourceLocation FRAME_ACTIVATED = new ResourceLocation(TemplateMod.MODID, "textures/entity/sixth_fighters_after.png");

    public SixthPhotoRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(SixthPhotoEntity entity) {
        return entity.isActivated() ? FRAME_ACTIVATED : FRAME_NORMAL;
    }

    @Override
    public void render(SixthPhotoEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
