...
public class NinthPhotoEntity extends HangingEntity implements IEntityAdditionalSpawnData {
    private static final EntityDataAccessor<Boolean> IS_ACTIVATED = SynchedEntityData.defineId(NinthPhotoEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> ACTIVATION_TICK = SynchedEntityData.defineId(NinthPhotoEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> WIDTH = SynchedEntityData.defineId(NinthPhotoEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> HEIGHT = SynchedEntityData.defineId(NinthPhotoEntity.class, EntityDataSerializers.INT);

    public NinthPhotoEntity(EntityType<? extends NinthPhotoEntity> type, Level level) {
        super(type, level);
    }

    public NinthPhotoEntity(Level level, BlockPos pos, Direction direction, int width, int height) {
        super(TemplateMod.NINTH_PHOTO.get(), level, pos);
