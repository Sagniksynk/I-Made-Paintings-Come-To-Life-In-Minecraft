...
public class TenthPhotoEntity extends HangingEntity implements IEntityAdditionalSpawnData {
    private static final EntityDataAccessor<Boolean> IS_ACTIVATED = SynchedEntityData.defineId(TenthPhotoEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> ACTIVATION_TICK = SynchedEntityData.defineId(TenthPhotoEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> WIDTH = SynchedEntityData.defineId(TenthPhotoEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> HEIGHT = SynchedEntityData.defineId(TenthPhotoEntity.class, EntityDataSerializers.INT);

    public TenthPhotoEntity(EntityType<? extends TenthPhotoEntity> type, Level level) {
        super(type, level);
    }

    public TenthPhotoEntity(Level level, BlockPos pos, Direction direction, int width, int height) {
        super(TemplateMod.TENTH_PHOTO.get(), level, pos);
