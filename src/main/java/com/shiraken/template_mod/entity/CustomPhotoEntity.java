...
public class CustomPhotoEntity extends HangingEntity {
    private static final EntityDataAccessor<Boolean> IS_ACTIVATED = SynchedEntityData.defineId(CustomPhotoEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> ACTIVATION_TICK = SynchedEntityData.defineId(CustomPhotoEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> WIDTH = SynchedEntityData.defineId(CustomPhotoEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> HEIGHT = SynchedEntityData.defineId(CustomPhotoEntity.class, EntityDataSerializers.INT);

    public CustomPhotoEntity(EntityType<? extends CustomPhotoEntity> type, Level level) {
        super(type, level);
    }

    public CustomPhotoEntity(Level level, BlockPos pos, Direction direction, int width, int height) {
        super(TemplateMod.CUSTOM_PHOTO.get(), level, pos);
    ...
    public void dropItem(@Nullable Entity entity) {
        ...
        // We do not drop an item when broken so it feels like a map decoration
    }
    ...
    public void onSyncedDataUpdated(EntityDataAccessor<?> key) {
        ...
        // If the server just told the client what the dimensions are, snap the anchor point perfectly!
