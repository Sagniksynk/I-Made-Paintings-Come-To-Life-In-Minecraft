...
public class SeventhPhotoEntity extends HangingEntity {
    private static final EntityDataAccessor<Boolean> IS_ACTIVATED = SynchedEntityData.defineId(SeventhPhotoEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> ACTIVATION_TICK = SynchedEntityData.defineId(SeventhPhotoEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> WIDTH = SynchedEntityData.defineId(SeventhPhotoEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> HEIGHT = SynchedEntityData.defineId(SeventhPhotoEntity.class, EntityDataSerializers.INT);

    public SeventhPhotoEntity(EntityType<? extends SeventhPhotoEntity> type, Level level) {
        super(type, level);
    }

    public SeventhPhotoEntity(Level level, BlockPos pos, Direction direction, int width, int height) {
        super(TemplateMod.SEVENTH_PHOTO.get(), level, pos);
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(HEIGHT, 2); // Wither painting is likely taller than it is wide
    }
