...
public class ThirdPhotoEntity extends HangingEntity {
    private static final EntityDataAccessor<Boolean> IS_ACTIVATED = SynchedEntityData.defineId(ThirdPhotoEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> ACTIVATION_TICK = SynchedEntityData.defineId(ThirdPhotoEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> WIDTH = SynchedEntityData.defineId(ThirdPhotoEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> HEIGHT = SynchedEntityData.defineId(ThirdPhotoEntity.class, EntityDataSerializers.INT);

    public ThirdPhotoEntity(EntityType<? extends ThirdPhotoEntity> type, Level level) {
        super(type, level);
    }

    public ThirdPhotoEntity(Level level, BlockPos pos, Direction direction, int width, int height) {
        super(TemplateMod.THIRD_PHOTO.get(), level, pos);
